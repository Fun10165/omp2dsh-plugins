...
| [`@omp2dsh/bang`](packages/bang/) | bang/bash 输入模式 | `/b` 快速运行命令（结果卡片 + 进上下文不唤醒）、`/bb`（仅卡片排除上下文），卡片默认展开 | ✅ 已实测，包已收编 |
...
插件开发经验与踩坑记录见 [docs/plugin-development-experience.md](docs/plugin-development-experience.md)。
